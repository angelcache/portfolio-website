export const activitiesCardsInfo = [
  {
    ...
    img: "./img/experiences/activities1-img.png",
  ...
  },
  {
    ...
    infoDesc: "Held dual roles within the team: contributing to software development by assisting with sensor integration for the CAN-RGX bioreactor experiment, while also co-developing the club’s official website from scratch with one other coder, improving visibility and outreach.",
    icon: "./img/icons/link-icon.png",
